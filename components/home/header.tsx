...
const Header: React.FC<HeaderProps> = ({ onAdd }) => (
  <div className="bg-background backdrop-blur-sm  sticky top-0 z-40">
    <div className="max-w-4xl mx-auto px-4 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          ...
          <Tooltip>
            <TooltipTrigger>
              <h1 className="text-xl font-bold text-primary">iamold</h1>
            </TooltipTrigger>
            <TooltipContent>
              <p className="text-white">
                Hovering here won’t help. You&apos;re still old.
              </p>
        ...
        <div className="flex items-center space-x-4">
          <Tooltip>
            ...
            <TooltipContent>
              <p className="text-white">Contribute on github?</p>
            </TooltipContent>
          </Tooltip>
          <ModeToggle />
          <button
            onClick={onAdd}
            className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white px-6 py-2 rounded-md font-semibold flex items-center space-x-2 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 cursor-pointer"
          >
